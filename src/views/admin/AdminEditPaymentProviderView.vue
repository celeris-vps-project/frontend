...
import { getGeneralSettings, getPaymentProvider, getProviderTypes, updatePaymentProvider } from '../../api/admin'
...
onMounted(async () => {
  try {
    const [types, provider, general] = await Promise.all([
      getProviderTypes(),
    ...
    webhookUrl.value = provider.webhook_url || ''
...
const epayWebhookPreview = computed(() => {
  if (providerType.value !== 'epay') return ''
  if (webhookUrl.value) return webhookUrl.value
...
async function handleUpdate() {
  ...
  if (providerType.value === 'epay' && !publicBaseUrl.value.trim()) {
    ...
    <div class="edit-provider-page">
      ...
      <div v-else class="form-container">
        ...
        <section v-if="selectedTypeInfo" class="form-section glass-card">
          ...
          <div v-if="providerType === 'epay'" class="form-group">
